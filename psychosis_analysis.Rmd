...
```{r}
v1data = read_csv("forager_results/output/lexical_results.csv") %>% mutate(version = "V1")
# v2data = read_csv("forager/output/corrected_V2_results/lexical_results.csv") %>% mutate(version = "V2")
combinedlexical = v1data #rbind(v1data, v2data)
# 
# items = combinedlexical %>% 
...
best_model_name = "phonologicaldynamiclocal_delta_rise_rise=0.0_fall=1.0"
## same as delta
...
individual_stats1 = read_csv("forager_results/output/individual_descriptive_stats.csv") %>%
...
combined_individual = individual_stats1# rbind(individual_stats1, individual_stats2)
