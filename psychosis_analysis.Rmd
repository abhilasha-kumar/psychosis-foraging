...
write.csv(v1data, "results_new/subject_lexical_results.csv", row.names = FALSE)
...
write.csv(best_betas, "results_new/subject_salience_values.csv", row.names = FALSE)
...
write.csv(best_betas_overall, "results_new/overall_salience_values.csv", row.names = FALSE)
```
...
write.csv(combinedswitch, "results_new/subject_switch_results.csv", row.names = FALSE)
...
write.csv(combined_individual, "results_new/subject_individual_stats.csv", row.names = FALSE)
