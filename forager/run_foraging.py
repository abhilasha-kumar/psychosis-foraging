...
from forager.switch import switch_delta, switch_multimodal, switch_simdrop, switch_norms_associative, switch_norms_categorical,switch_multimodaldelta, switch_norms_troyerextended
...
if sys.argv[0] != 'run_foraging.py': # check the reference path
    troyerexpath = os.path.join(fp,'data/norms/troyer_extended_lundin_2024_03_22.csv')
