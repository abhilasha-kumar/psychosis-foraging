...
```{r}
v1data = read_csv("forager_psychosis/output/lexical_results.csv") %>% mutate(version = "V1")
...
```{r}
switchv1data = read_csv("forager_psychosis/output/switch_results.csv") %>% 
  mutate(v = "V1")
...
```{r}
v1models = read_csv("forager_psychosis/output/model_results.csv") %>%
  mutate(version = "V1")
...
individual_stats1 = read_csv("forager_psychosis/output/individual_descriptive_stats.csv") %>%
